...
\texttt{exercice1.c} dans un nouveau fichier \emph{exercice%\arabic{exercicenum}%.c}.
...
\texttt{exercice\arabic{exercicenum}} un programme qui affiche les 3
